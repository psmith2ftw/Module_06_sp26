# Battery Design Parameters — Rohana, Jule
...
Suppose you pair **Potassium (anode)** with **Manganese dioxide (cathode)**.
The balanced equation transfers n = 2 electron(s) per formula unit.
Stoichiometric coefficients: 2 × anode, 1 × cathode.

```
Active mass = (2 × 39.098 g/mol  [elemental, anode])
            + (1 × 86.937 g/mol  [compound, cathode])
           = 165.133 g/mol
           = 0.165133 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (2 × 96,485 × 1,000) / (3,600 × 0.165133)
         = 324,604 mAh/kg
```
