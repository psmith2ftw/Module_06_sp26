# Battery Design Parameters — Krzyzanowski, Elizabeth
...
### Iodine  (I₂)
**Standard reduction half-reaction:** I₂(s) + 2e⁻ → 2I⁻(aq)
**E° = +0.54 V**
...
| Iodine | I₂ | I₂(s) + 2e⁻ → 2I⁻(aq) | +0.54 | **253.809** | I⁻ oxidised to I₂; use I₂ MW | I₂(s) | **253.809** | I₂ solid reduced to I⁻; use I₂ MW |

### Worked example using your materials

Suppose you pair **Lithium (anode)** with **Iron(III) / Iron(II) (cathode)**.
The balanced equation transfers n = 1 electron(s) per formula unit.
Stoichiometric coefficients: 1 × anode, 1 × cathode.

```
Active mass = (1 × 6.941 g/mol  [elemental, anode])
            + (1 × 162.204 g/mol  [compound, cathode])
           = 169.145 g/mol
           = 0.169145 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (1 × 96,485 × 1,000) / (3,600 × 0.169145)
         = 158,452 mAh/kg
```
