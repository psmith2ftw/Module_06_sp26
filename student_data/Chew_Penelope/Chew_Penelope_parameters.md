# Battery Design Parameters — Chew, Penelope
...
Suppose you pair **Sodium (anode)** with **Iodine (cathode)**.
The balanced equation transfers n = 2 electron(s) per formula unit.
Stoichiometric coefficients: 2 × anode, 1 × cathode.

```
Active mass = (2 × 22.990 g/mol  [elemental, anode])
            + (1 × 253.809 g/mol  [compound, cathode])
           = 299.789 g/mol
           = 0.299789 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (2 × 96,485 × 1,000) / (3,600 × 0.299789)
         = 178,802 mAh/kg
```
