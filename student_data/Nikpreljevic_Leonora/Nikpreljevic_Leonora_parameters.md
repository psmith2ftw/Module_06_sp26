# Battery Design Parameters — Nikpreljevic, Leonora
...
### Magnesium  (Mg)
**Standard reduction half-reaction:** Mg²⁺(aq) + 2e⁻ → Mg(s)
**E° = -2.37 V**
...
### Nickel  (Ni)
**Standard reduction half-reaction:** Ni²⁺(aq) + 2e⁻ → Ni(s)
**E° = -0.25 V**
...
|----------|--------|--------------------------|--------|---------------------|----------------|-----------------|---------------------|-----------------|
| Magnesium | Mg | Mg²⁺(aq) + 2e⁻ → Mg(s) | -2.37 | **24.305** | Mg metal, elemental | MgSO₄ | **120.366** | Mg²⁺ sourced from MgSO₄ solution |
...
| Nickel | Ni | Ni²⁺(aq) + 2e⁻ → Ni(s) | -0.25 | **58.693** | Ni metal, elemental | NiSO₄ | **154.756** | Ni²⁺ sourced from NiSO₄ solution |

### Worked example using your materials

Suppose you pair **Magnesium (anode)** with **Gold (cathode)**.
The balanced equation transfers n = 6 electron(s) per formula unit.
Stoichiometric coefficients: 3 × anode, 2 × cathode.

```
Active mass = (3 × 24.305 g/mol  [elemental, anode])
            + (2 × 303.325 g/mol  [compound, cathode])
           = 679.565 g/mol
           = 0.679565 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (6 × 96,485 × 1,000) / (3,600 × 0.679565)
         = 236,634 mAh/kg
```
...
|-----------|-------|-------|
| Suggested R_int | **10.0 Ω** | Adjust if your cell resembles a different type |
