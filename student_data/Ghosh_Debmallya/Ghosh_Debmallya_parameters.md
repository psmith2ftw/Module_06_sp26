# Battery Design Parameters — Ghosh, Debmallya
...
Suppose you pair **Lithium (anode)** with **Silver (cathode)**.
...
Active mass = (1 × 6.941 g/mol  [elemental, anode])
           ...
           = 176.813 g/mol
           = 0.176813 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (1 × 96,485 × 1,000) / (3,600 × 0.176813)
         = 151,580 mAh/kg
```
