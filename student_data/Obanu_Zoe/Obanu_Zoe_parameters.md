# Battery Design Parameters — Obanu, Zoe
...
Suppose you pair **Sodium (anode)** with **Manganese dioxide (cathode)**.
...
Active mass = (2 × 22.990 g/mol  [elemental, anode])
           ...
           = 132.917 g/mol
           = 0.132917 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (2 × 96,485 × 1,000) / (3,600 × 0.132917)
         = 403,280 mAh/kg
```
