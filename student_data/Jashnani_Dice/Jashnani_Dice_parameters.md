# Battery Design Parameters — Jashnani, Dice
...
### Lead  (Pb)
**Standard reduction half-reaction:** Pb²⁺(aq) + 2e⁻ → Pb(s)
**E° = -0.13 V**
...
| Lead | Pb | Pb²⁺(aq) + 2e⁻ → Pb(s) | -0.13 | **207.200** | Pb metal, elemental | Pb(NO₃)₂ | **331.208** | Pb²⁺ sourced from Pb(NO₃)₂ solution |

### Worked example using your materials

Suppose you pair **Magnesium (anode)** with **Silver (cathode)**.
The balanced equation transfers n = 2 electron(s) per formula unit.
Stoichiometric coefficients: 1 × anode, 2 × cathode.

```
Active mass = (1 × 24.305 g/mol  [elemental, anode])
            + (2 × 169.872 g/mol  [compound, cathode])
           = 364.049 g/mol
           = 0.364049 kg/mol   ← divide by 1000 before plugging in

Capacity = (n × 96,485 × 1,000) / (3,600 × mass_kg)
         = (2 × 96,485 × 1,000) / (3,600 × 0.364049)
         = 147,241 mAh/kg
```
